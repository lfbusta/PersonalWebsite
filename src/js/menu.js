    ...
    render(){
        return(
            <nav className="containerMenu">
                <a href="../public" className="buttonMenu buttonMenu_main animation__show_buttonMenu_projects" id="buttonMenu_projects"><img src="../resources/buttonProjects.svg" alt=""/></a>
                ...
                <img src="../resources/buttonStack.svg" alt="" className="buttonMenu buttonMenu_main animation__hide_buttonMenu_stack" id="buttonMenu_stack"/>
            </nav>
        );
    }
}
